...
def drawable(filename):
    flag = False
    with open("/home/naveen/Downloads/Django_work/webserver_part1/myapp/{}".format(filename), 'rb') as f:
        while True:
            line = f.readline()
            if line == '':
                continue
    ...
    with open("./home/naveen/Downloads/Django_work/webserver_part1/myapp/{}".format(filename), 'rb') as f:
        ...
        while True:
            ...
            if mark.find("in") != -1:
                ...
                mk = 't'
            else:-ATP requires a modern web browser with JavaScript enabled. To view the submission status of a job, pop-ups must not be blocked. The following browsers have been thro
                mk = 'o'
            print(mark)
...
if __name__ == '__main__':
    datapath = '/home/naveen/Downloads/Django_work/webserver_part1/myapp'
