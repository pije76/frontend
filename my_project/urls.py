...
urlpatterns = [
    ...
    path('load_example', load_ex, name='load_example'),
    path('load_example1', load_ex1, name='load_example1'),
    path('load_contact', load_contact, name='load_contact'),
    path('load_jobqueue', load_jobqueue, name='load_jobqueue'),
    path('load_help', load_help, name='load_help'),
